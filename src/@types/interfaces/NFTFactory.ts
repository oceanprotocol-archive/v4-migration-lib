...
export class NftFactory {
  ...
  constructor(
    ...
    this.factory721Abi =
      factory721Abi || (defaultFactory721Abi.abi as AbiItem[])
    this.web3 = web3
  ...
  public async getCurrentNFTTemplateCount(): Promise<number> {
    const count = await this.factory721.methods
  ...
  public async getTokenTemplate(index: number): Promise<Template> {
    const template = await this.factory721.methods
  ...
  public async checkNFT(nftAddress: string): Promise<String> {
    const confirmAddress = await this.factory721.methods
      .erc721List(nftAddress)
      .call()
  ...
  public async reactivateNFTTemplate(
    ...
    const estGas = await this.estGasReactivateNFTTemplate(
      address,
      templateIndex
    )
  ...
  public async reactivateTokenTemplate(
    ...
    const estGas = await this.estGasReactivateTokenTemplate(
      address,
      templateIndex
    )
  ...
  public async estGasCreateNftErcWithDispenser(
    ...
    try {
      ...
      LoggerInstance.error(
        'Failed to estimate gas for createNftErcWithDispenser',
        e
      )
    }
    return estGas
