import { Authentication } from '../../@types/v3/Authentication'
import { Proof } from '../../@types/v3/Proof'
import { PublicKey } from '../../@types/v3/PublicKey'
import { Service, ServiceType } from '../../@types/v3/Service'
import { BestPrice } from '../../@types/v3/BestPrice'
import { DataTokenInfo } from '../../@types/v3/DataTokenInfo'
import { PurgatoryData } from '../../@types/v3/PurgatoryData'
import { Credentials } from '../../@types/v3/Credentials'
import { Event } from '../../@types/v3/Event'
...
export class DDO {
   ...
   */
  public getChecksum(web: Web3): string {
